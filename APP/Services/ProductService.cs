    ...
    public class ProductService : Service<Product>, IService<ProductRequest, ProductResponse>
    {
        ...
        public List<ProductResponse> List()
        {
            ...
            return Query().Select(p => new ProductResponse // () after the class name may not be used
            {
                ...
                // Way 1:
                //Stores = string.Join("<br>", p.ProductStores.Select(ps => ps.Store.Name)),

                // Way 2:
                StoreList = p.ProductStores.Select(ps => new StoreResponse
                {
                    Id = ps.Store.Id,
                    Guid = ps.Store.Guid,
                    Name = ps.Store.Name,
                    IsVirtual = ps.Store.IsVirtual,
        ...
        public ProductResponse Item(int id)
        {
            ...
            return new ProductResponse
            {
                ...
                // Way 1:
                //Stores = string.Join("<br>", entity.ProductStores.Select(ps => ps.Store.Name)),

                // Way 2:
                StoreList = entity.ProductStores.Select(ps => new StoreResponse
                {
                    Id = ps.Store.Id,
                    Guid = ps.Store.Guid,
                    Name = ps.Store.Name,
