...
{
    /// <summary>
    /// Represents a grouped summary of cart items for a user and books.
    ...
    public class CartItemGroupedBy
    {
        ...
        /// <summary>
        /// The unique identifier of the book being grouped in the cart.
        /// </summary>
        ...
        /// <summary>
        /// The total count of this book in the user's cart.
